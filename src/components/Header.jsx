  ...
  return (
    <header>
        <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10" >
            ...
            <Image src="https://links.papareact.com/c2cdd5" alt="" width={300} height={100} 
            ...
            <div className="flex items-center space-x-5 flex-1 justify-end w-full " >
                ...
                {/**Avatar */}
                <Avatar name="Asyncrite Simo" round size="50" className="cursor-pointer" color="#0055D1" />
            </div>
        </div>

        <div className='flex items-center justify-center px-5 py-2 md:py-5' > 
            <p className='flex items-center font-light text-sm p-5
